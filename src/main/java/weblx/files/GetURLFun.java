...
//
// Files_GetURL(url:string, filename, [ param, [ headers]] )
//
public class GetURLFun extends AbstractFunExpr
{
    ...
    public Expr Apply(Context c, Vector args, Expr callsite) throws WebLException {
        ...
        try {
            return Net.GetURLDownload(url, params, headers, options, filename);
