...
public class AppendToFileFun extends AbstractFunExpr
{
    ...
    static public void AppendToFile(String filename, String data, String enc) throws IOException {
    ...
    public Expr Apply(Context c, Vector args, Expr callsite) throws WebLException {
        ...
        try {
            AppendToFile(fname, result, enc);
        } catch(IllegalArgumentException E) {
            throw new WebLException(c, callsite, "UnsupportedEncoding", "Unsupported encoding " + enc);
        } catch(UnsupportedEncodingException E) {
            throw new WebLException(c, callsite, "UnsupportedEncoding", "Unsupported encoding " + enc);
        } catch(IOException E) {
            throw new WebLException(c, callsite, "SaveError", "unable to append output to " + fname + ", " + E);
        }
